...
import { dataURLtoFile, captureElementAsImage } from "../utils/helper";
...
const EditResume = () => {
  ...
  // take back to previous state or take back to first page or to dashboard
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
      ...
      case "contact-info":
        return (
          <ContactInfoForm
            ...
            onNext={validateAndNext} // ✅ Add this line
          />
        )
  ...
  // remove information using index
  ...
  // it will help in choosing the preview and helps in downloading the resume also saves the resume as an image
  const uploadResumeImages = async () => {
    try {
      ...
      const { thumbnailLink } = await uploadResponse.data
  ...
  //  this function update resume and will help in updation in backend 
  ...
  // all these functions will be used in editing the resumes.
  // all the codes that is given is on github 
  ...
  return (
    <DashboardLayout>
        ...
        <Modal isOpen={openPreviewModal} onClose={()=> setOpenPreviewModal(false)}
          ...
          {/* now thumbnail issue will be fixed here */}
