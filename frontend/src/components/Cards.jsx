...
//   created at
  ...
  const formattedUpdatedDate = updatedAt
    ...
    // get color according to completion percentage
...
//   get icon for completion percentage
    ...
    >
      {thumbnailImg ? (
        ...
        <div className="w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br from-violet-50 via-violet-600 to-fuchsia-50">
          ...
          <span className="text-gray-700 font-bold">No Preview Available</span>
        </div>
      )}
    </div>
  );
